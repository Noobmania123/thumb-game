...
# Prefer software rendering on Windows/Linux low-power GPUs to avoid black-screen driver issues.
# Leave macOS on its default SDL backend so Apple Silicon can use the native renderer.
